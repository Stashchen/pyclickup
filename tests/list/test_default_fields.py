...
# ID field
def test_get_id__exists__return_string(
    client_list_1, raw_task_for_client_1
):
    
    task = client_list_1(raw_task_for_client_1)
...
# Name field
def test_get_name__exists__return_string(
    client_list_1, raw_task_for_client_1
):
    task = client_list_1(raw_task_for_client_1)
...
# Description field
def test_get_description__exists__return_string(
    client_list_1, raw_task_for_client_1
):
    task = client_list_1(raw_task_for_client_1)
...
# URL field
def test_get_url__exists__return_string(
    client_list_1, raw_task_for_client_1
):
    
    task = client_list_1(raw_task_for_client_1)
        
    assert task.url == "https://app.clickup.com/t/client_1_task_id"
